// GENERATED from lib/tutor/merge.ts — do not edit. Run: npm run build:tutor-fn
import type { AxisResult, TutorResult } from "./schema.ts";
import type { ValidationSuccess } from "./schema.ts";
import { deriveResult } from "./schema.ts";
